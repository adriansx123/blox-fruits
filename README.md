...
local Window = OrionLib:MakeWindow({Name = "Zeldris Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Zeldris Hub"})
...
W:AddLabel("[+] Zeldris Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Zeldris Hub(Noitification)",
